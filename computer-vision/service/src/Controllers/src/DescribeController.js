...
class DescribeController {
     ...
     */
    init(router) {
        router.post('/describe',upload.single('file'),bodyParser.json(),this.fileMiddle, this.base64Middle, this.analyzeMiddle, this.sendJson);
    ...
    analyzeMiddle(req, res, next) {
        res.analyzePromise = msCVApi.describe(res.content, {});
        next(); // pass to next middleware
    }
...
module.exports = new DescribeController();