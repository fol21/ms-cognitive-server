...
class AnalyzeController {
     ...
     */
    init(router) {
        router.post('/analyze',upload.single('file'),bodyParser.json(),this.fileMiddle, this.base64Middle, this.analyzeMiddle, this.sendJson);
    ...
    analyzeMiddle(req, res, next) {
        res.analyzePromise = msCVApi.analyze(res.content, {visualFeatures:"Faces",details:"Celebrities", language:"en"});
        next(); // pass to next middleware
    }
